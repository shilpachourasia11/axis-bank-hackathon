...
class Actions(object):
    ...
    @classmethod
    def checkUniqueness(self, aadharNo,database_path):
        try:
            res = False
            fileName = database_path + "/uniqueIds.csv"
    ...
    @classmethod
    def convert_and_save(self, img, folderName,database_path):
    ...
    @classmethod
    def getUserData(self, folderName,database_path):
        path = database_path+"/{}/details.csv".format(folderName)
        try:
            header = []
